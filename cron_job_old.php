...
use data\HotelFlag;
    ...
    try{
            ...
            $hotels = $regionData['hotels'];
            
            foreach ($hotels as $hotelId) {
                
                $hotelEntries = getHotelDetails($hotelId, $headers);
                
                // $json_hotel_entries = json_decode($hotelEntries, true);
                // echo "<br>Hotel response: " . print_r($hotelEntries['id'], JSON_PRETTY_PRINT);
        ...
        // foreach ($allHotels as $countryId => $regions) {
        //      foreach ($regions as $regionId => $hotels) {
        ...
        //             error_log("foreach hotel in cron job:");
    ...
    */
        ...
        // $hotel = getHotelDetails($hotel_name, $headers);
        ...
        if (HotelFlag::isHotelFound()){
            ...
            $location_relationships->location_from = array($parent_location, $hotel_location['id']);
    ...
    echo "<b>All hotels inserted successfully!</b>";
