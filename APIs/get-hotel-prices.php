...
if (isset($data['ids']) && isset($data['checkin']) && isset($data['checkout']) && isset($data['currency']) && isset($data['adults']) && isset($data['children']) && isset($data['nationality'])) {
    ...
    try {
        ...
        echo json_encode($responseData); // Return the response data in JSON format
