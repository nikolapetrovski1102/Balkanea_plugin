...
class PostMetaValues
{
    ...
    public function create(): bool
    {
        try {
            ...
            error_log('Error in PostMetaValues::create: ' . $ex->getMessage());
            return false;
        }
    }
    ...
    public function update(): bool
    {
        try {
            ...
            error_log('Error in PostMetaValues::update: ' . $ex->getMessage());
            return false;
        }
    }
    ...
    public function delete($meta_key): bool
    {
        ...
        try {
            ...
            error_log('Error in PostMetaValues::delete: ' . $ex->getMessage());
            return false;
        }
    }
    ...
    public function bulkDelete(array $meta_keys): bool
    {
        ...
        try {
            ...
            error_log('Error in PostMetaValues::bulkDelete: ' . $ex->getMessage());
            return false;
        }
    }
