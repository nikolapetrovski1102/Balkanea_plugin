<?php 
    ...
    if (!file_exists($dir)) {
        echo 'File ' . $dir . ' does not exists <br>';
        echo 'path: ' . $path;
        return false;
    }
    ...
    if (isset($_GET['delete_post_name'])){
        ...
        if ($results === false) {
            ...
            deleteDirectory("/home/balkanea/public_html/wp-content/uploads/RateHawk/{$post_name}");
            header("Location: " . 'https://staging.balkanea.com/hotels');
            exit();
        }
    }
